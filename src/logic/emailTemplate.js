...
export function buildResultEmailHtml({ ageLabel, total, level, recommendations, priorityNote }) {
  ...
  <div style="font-family: -apple-system, Arial, sans-serif; max-width: 560px; margin: 0 auto; color:#24333D;">
    <h1 style="font-size:20px; color:#245B78; margin: 0 0 8px;">Your educational strategy results</h1>
    <p style="margin: 0 0 16px; color:#5B6B76;">Child's age: ${escapeHtml(ageLabel)} · Total score: ${total} of 21</p>
    ...
    <h2 style="font-size:16px; color:#245B78; margin: 0 0 8px;">What to focus on first</h2>
    <ul style="padding-left: 20px; margin: 0 0 20px; line-height:1.5;">${recItems}</ul>` : ""}

    <h2 style="font-size:16px; color:#245B78; margin: 0 0 8px;">Questions to reflect on</h2>
